    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        {SAMPLE_IMAGES.map((s) => {
          ...
          return (
            ...
            >
              <Image src={s.src || "/placeholder.svg"} alt={s.name} fill className="object-contain p-1" sizes="160px" />
              {active && (
      ...
      {selected?.isUpload && (
        <div className="relative aspect-video overflow-hidden rounded-lg border border-primary bg-card ring-2 ring-primary/30">
          ...
          <img src={selected.src || "/placeholder.svg"} alt={selected.name} className="h-full w-full object-contain" />
